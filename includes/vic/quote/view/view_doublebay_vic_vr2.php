<?php  
//error_log("inside VR2", 3,'C:\\xampp\htdocs\\vergola_contract_system_v4_sa\\my-error.log');
...
function generateRowItem2($section,$projectId=null,$VergolaType="Double Bay VR2"){
	...
	if($section=="frame"){  
		...
		while ($r = mysql_fetch_assoc($fw)) { 
			...
			$tr .= "<tr class=\"tr-vergola ".($isFirst?'trv-1':'').($isSecond?'trv-2':'')." ".($r['is_additional']==1?"tr-added-item":"")." \">"; 
