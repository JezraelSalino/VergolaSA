...
$next_increment = $row['Auto_increment'];
$getprojectid = 'PRV'.$next_increment;
//error_log("2: ".print_r($row,true), 3,'C:\\xampp\htdocs\\vergola_contract_system_v4_sa\\my-error.log');
...
{	
//error_log("Run in : save-singlebay-vr1", 3,'C:\\xampp\htdocs\\vergola_contract_system_v4_sa\\my-error.log');
	...
	if($section=="frame"){
		...
		while ($r = mysql_fetch_assoc($fw)) { 
			...
			$tr .= "<tr>"; 
					...
					}elseif(($item["inventoryid"]=="IRV43" || $item["inventoryid"]=="IRV46" ) || ($item["inventoryid"]=="IRV44")){ //error_log("2nd", 3,'C:\\xampp\htdocs\\vergola_contract_system_v4_sa\\my-error.log');
