	...
	if($section=="frame"){
		...
		while ($r = mysql_fetch_assoc($fw)) { 
			...
			$tr .= "<tr>"; 
					...
					}elseif(($item["inventoryid"]=="IRV43" || $item["inventoryid"]=="IRV46" ) || ($item["inventoryid"]=="IRV44" || $item["inventoryid"]=="IRV280")){ //error_log("2nd", 3,'C:\\xampp\htdocs\\vergola_contract_system_v4_sa\\my-error.log'); IRV280
