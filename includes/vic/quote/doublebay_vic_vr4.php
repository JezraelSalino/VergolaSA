...
// 	 error_log("incorrect vr2: ".$_POST['framework'], 3,'C:\\xampp\htdocs\\vergola_contract_system_v4_sa_prod\\my-error.log');
// 	 //$framework = "Double Bay VR2"; //set default value for get default item in database.
// 	//return;
// }else{
// 	error_log("correct vr2: ".$_POST['framework'], 3,'C:\\xampp\htdocs\\vergola_contract_system_v4_sa_prod\\my-error.log');
// }  

//echo "HERE";return;
//error_log(print_r($_POST,true), 3,'C:\\xampp\htdocs\\vergola_contract_system_v4_sa_prod\\my-error.log');
$next_increment = 0;
...
if(isset($_POST['save-doublebay-vr4']) || isset($_POST['save-close-doublebay-vr4'])){	
	...
	if ($cnt6 > 0) { // && $cnt == $cnt2 && $cnt2 == $cnt3 && $cnt3 == $cnt4 && $cnt4 == $cnt5 && $cnt5 == $cnt6 && $cnt6 == $cnt7 && $cnt7 == $cnt8 && $cnt8 == $cnt9
		...
		//echo $queryn; return;
		//error_log($query, 3,'C:\\xampp\htdocs\\vergola_contract_system_v4_sa_prod\\my-error.log');  //exit(); 
	...
	'$default_color',
	$is_tender_quote)";
	//error_log($queryp, 3,'C:\\xampp\htdocs\\vergola_contract_system_v4_sa_prod\\my-error.log'); 
	...
	if ($cnt > 0) {
		...
		//error_log("INSERT INTO ver_chronoforms_data_measurement_vic: ".$query, 3,'C:\\xampp\htdocs\\vergola_contract_system_v4_sa_prod\\my-error.log'); 
	...
	if ($i1 && $i2 && $i3) {
		...
		mysql_query($sql); 	 
		//error_log($sql, 3,'C:\\xampp\htdocs\\vergola_contract_system_v4_sa_prod\\my-error.log'); 	 
	    ...
	    $db_result = 0;
	    //error_log("DB Failed: i1:".$i1 .' i2:'. $i2 .' i3:'. $i3 .' i4:'. $i4 .' i5:'. $i5, 3,'C:\\xampp\htdocs\\vergola_contract_system_v4_sa_prod\\my-error.log');
...
function generateRowItem2($section){ //type = double bay vr2, double bay vr3, double bay vr2 - gutter
	...
	$tr = "";
	//$framework = $_POST['framework']; 
	//error_log("Inside generateRowItem2 framework: ".$_POST['framework'], 3,'C:\\xampp\htdocs\\vergola_contract_system_v4_sa_prod\\my-error.log');
	...
	if($section=="frame"){
		$filter_framework = "";
	 	...
	 	//error_log("Inside generateRowItem2 framework: ".$framework, 3,'C:\\xampp\htdocs\\vergola_contract_system_v4_sa_prod\\my-error.log');
	 	//error_log("FRAMEWORK: ".$framework, 3,'C:\\xampp\htdocs\\vergola_contract_system_v4_sa_prod\\my-error.log');
		...
		//error_log("SELECT  * FROM ver_vergola_default_framework_items WHERE framework = '{$filter_framework}'  AND (LOWER(section) = 'frame' OR LOWER(section) = 'posts') ORDER BY FIELD(inventoryid, 'IRV122','IRV25','IRV23','IRV15','IRV109','IRV111','IRV120','IRV3') DESC ", 3,'C:\\xampp\htdocs\\vergola_contract_system_v4_sa_prod\\my-error.log');
		...
		while ($r = mysql_fetch_assoc($framework)) {
			...
			//error_log(print_r($item,true), 3,'C:\\xampp\htdocs\\vergola_contract_system_v4_sa_prod\\my-error.log');
			$tr .= "<tr>"; 					 
					$lw = "";
...
//error_log(" generateRowItem2: ".generateRowItem2("frame"), 3,'C:\\xampp\htdocs\\vergola_contract_system_v4_sa_prod\\my-error.log');
...
// End of Table
echo "</table>"; 
//error_log("FINAL output vr2: ".$framework, 3,'C:\\xampp\htdocs\\vergola_contract_system_v4_sa_prod\\my-error.log');
?>
